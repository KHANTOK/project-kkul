...
import 'package:kkul_app/screen/Admin/addDevice.dart';
...
class _ManageDeviceScreenState extends State<ManageDeviceScreen> {
  ...
  List<bool> _switchValues = List.generate(devices.length, (_) => false);
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => CreateDeviceScreen()));
        },
        // tooltip: 'Increment',
